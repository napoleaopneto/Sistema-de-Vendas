  ...
  type
   TControllerCrud = class(TInterfacedObject, iControllerCrud)
     ...
     class function New : iControllerCrud;
       ...
       function _OpenClientes : iSQLOpen;
       function _OpenPedidos : iSQLOpen;
...
function TControllerCrud._OpenClientes: iSQLOpen;
begin
  result := TSQLQuery.NewOpen;
end;

function TControllerCrud._OpenPedidos: iSQLOpen;
begin
  result := TSQLQuery.NewOpen;
end;
